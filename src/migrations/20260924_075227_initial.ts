...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_pages_blocks_product_grid_populate_by" AS ENUM('featured', 'category', 'latest', 'selection');
  ...
  CREATE TYPE "public"."enum__pages_v_blocks_product_grid_populate_by" AS ENUM('featured', 'category', 'latest', 'selection');
  ...
  CREATE TABLE "products_video_urls" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"url" varchar
  ...
  CREATE TABLE "_products_v_version_video_urls" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"url" varchar,
  ...
  CREATE TABLE "pages_blocks_product_grid" (
  	...
  	"id" varchar PRIMARY KEY NOT NULL,
  	"heading" varchar,
  	"populate_by" "enum_pages_blocks_product_grid_populate_by" DEFAULT 'featured',
  ...
  CREATE TABLE "_pages_v_blocks_product_grid" (
  	...
  	"id" serial PRIMARY KEY NOT NULL,
  	"heading" varchar,
  	"populate_by" "enum__pages_v_blocks_product_grid_populate_by" DEFAULT 'featured',
  	"limit" numeric DEFAULT 8,
  	"show_view_all" boolean DEFAULT true,
  	"_uuid" varchar,
  	"block_name" varchar
  ...
  CREATE TABLE "site_settings" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"site_name" varchar DEFAULT 'H2T Cobra' NOT NULL,
  	"logo_id" integer,
  	"tagline" varchar,
  	"facebook_url" varchar,
  ...
  ALTER TABLE "products_video_urls" ADD CONSTRAINT "products_video_urls_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."products"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "_products_v_version_video_urls" ADD CONSTRAINT "_products_v_version_video_urls_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_products_v"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "_products_v_version_colors" ADD CONSTRAINT "_products_v_version_colors_image_id_media_id_fk" FOREIGN KEY ("image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  CREATE INDEX "products_video_urls_order_idx" ON "products_video_urls" USING btree ("_order");
  CREATE INDEX "products_video_urls_parent_id_idx" ON "products_video_urls" USING btree ("_parent_id");
  ...
  CREATE INDEX "_products_v_version_video_urls_order_idx" ON "_products_v_version_video_urls" USING btree ("_order");
  CREATE INDEX "_products_v_version_video_urls_parent_id_idx" ON "_products_v_version_video_urls" USING btree ("_parent_id");
  ...
  CREATE INDEX "_products_v_version_colors_image_idx" ON "_products_v_version_colors" USING btree ("image_id");
